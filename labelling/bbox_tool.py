...
SIZE = 256, 256
# regex for graphics file format attention un format à la fois !
FILES_FORMAT_REGEX = '*.[BbMm]*[Pp]'
#FILES_FORMAT_REGEX = '*.[JjPp]*[Gg]'
#FILES_FORMAT_REGEX = '*.[PpNn]*[Gg]'

# si problème d'affichage dans la fenetre grephique
# modifier dans la fonction loadImage(self): basewidth = 900 par 700 ou moins 
# conserver la taille de la modification car vous en aurez besoin pour le fichier resize.py
